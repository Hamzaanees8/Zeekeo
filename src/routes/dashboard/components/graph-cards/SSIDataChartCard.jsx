...
const SSIDataChartCard = ({
  ...
  return (
    <div className="bg-[#FFFFFF] shadow-md px-[12px] py-[12px] rounded-[8px] w-full grid-col-3">
      <div className="bg-[#FFFFFF] shadow-md px-[12px] py-[12px] rounded-[8px] w-full relative h-full">
        <div className="grid grid-cols-3 items-start gap-6">
          ...
          <div className="flex flex-col items-start justify-between">
            <div className="text-[16px] text-[#1E1D1D] mb-0">{title}</div>
      ...
      <div className="flex flex-col items-center justify-start">
        <div className="flex items-center gap-2 mb-2">
          <h4 className="text-sm text-gray-500">73</h4>
          <p className="text-sm text-gray-700">out of 100</p>
        </div>
        <TooltipInfo text="Click on label to hide/show specific company size from chart." />
      </div>

      <div className="flex flex-col gap-[10px] text-[10px]">

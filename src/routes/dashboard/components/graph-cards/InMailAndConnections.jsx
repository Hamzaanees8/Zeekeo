...
const InMailAndConnections = ({ outerPercent = 80, innerPercent = 60 }) => {
  const radius = 50;
  ...
  return (
    <div className="bg-[#FFFFFF] shadow-md px-[12px] py-[12px] h-full flex flex-col justify-between relative rounded-[8px]">
      {/* Title */}
...
export default InMailAndConnections;

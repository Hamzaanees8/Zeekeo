...
const TopCampaignsListCard = ({ title, campaigns = [], tooltipText = "", viewAllLink = "#" }) => {
  return (
    <div className="bg-[#ffffff] px-4 py-4 w-full shadow-md min-h-full relative flex flex-col justify-between gap-2 rounded-[8px]">
      {/* Title */}

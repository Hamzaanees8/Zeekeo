...
const LinkedInMessages = ({ total = 0, max = 0 }) => {
  const clampedTotal = Math.min(Number(total), max);
  const percent = (clampedTotal / max) * 100;
  ...
  return (
    <div className="bg-[#FFFFFF] shadow-sm px-[12px] py-[12px] w-full flex flex-col justify-between relative h-full">

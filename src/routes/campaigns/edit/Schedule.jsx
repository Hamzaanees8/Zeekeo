...
const Schedule = () => {
  ...
  const tz_location_names = [
    ...
    { offset: -360, name: "(GMT -6:00) Central Time (US & Canada), Mexico City" },
    { offset: -300, name: "(GMT -5:00) Eastern Time (US & Canada), Bogota, Lima" },
    { offset: -240, name: "(GMT -4:00) Atlantic Time (Canada), Caracas, La Paz" },
    ...
    { offset: 0, name: "(GMT) Western Europe Time, London, Lisbon, Casablanca" },
    { offset: 60, name: "(GMT +1:00) Brussels, Copenhagen, Madrid, Paris" },
    { offset: 120, name: "(GMT +2:00) Athena, Bucharest, Kaliningrad, South Africa" },
    { offset: 180, name: "(GMT +3:00) Baghdad, Riyadh, Moscow, St. Petersburg" },
    { offset: 210, name: "(GMT +3:30) Tehran" },
    { offset: 240, name: "(GMT +4:00) Abu Dhabi, Muscat, Baku, Tbilisi" },
    { offset: 270, name: "(GMT +4:30) Kabul" },
    { offset: 300, name: "(GMT +5:00) Ekaterinburg, Islamabad, Karachi, Tashkent" },
    ...
    { offset: 660, name: "(GMT +11:00) Magadan, Solomon Islands, New Caledonia" },
    { offset: 720, name: "(GMT +12:00) Auckland, Wellington, Fiji, Kamchatka" },
  ];

...
const SideBar = () => {
  ...
  return (
    <div
      className={`bg-white h-screen border-r border-gray-200 shadow-xl flex flex-col shrink-0 sticky top-[1px] transition-all duration-300 ease-in-out z-50 ${
        isCollapsed
          ? "w-auto px-4 py-[43px]"
          : "w-[330px] p-[43px] overflow-hidden"
      }`}
    >

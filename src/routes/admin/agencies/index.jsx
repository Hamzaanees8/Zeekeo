    ...
    <div className="flex flex-col gap-y-[18px] bg-[#EFEFEF] px-[26px] pt-[45px] pb-[200px]">
      ...
      <div className="flex items-center justify-between mt-[17px]">
        ...
        <div className="flex items-center gap-x-[9px]">
          <button
            className="flex items-center justify-center gap-x-2.5 text-[13px] font-normal px-4 py-1 h-[40px] w-[140px] text-white bg-[#0077B6] cursor-pointer border border-[#0077B6]"

...
const Internal = ({ selected }) => {
  ...
  useEffect(() => {
    ...
    Object.entries(data).forEach(([key, value]) => {
      const entries = Object.entries(value.hourlyBreakdown)
  ...
  return (
    <div>
      <div className="p-4 grid gap-3 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2">

...
const ConversationSentiment = ({ conversation, email }) => {
      ...
      <div className="flex flex-col items-center gap-y-2">
        ...
        <div className="flex gap-2">
          <div
            ...
            onClick={() =>
              !updating && handleUpdate("sentiment", "meeting_booked")
            }
          >
      ...
      <div className="flex flex-col items-center gap-y-2">
        ...
        <div className="flex gap-2">
          <div
            ...
            onClick={() =>
              !updating && handleUpdate("sentiment", "deal_closed")
            }
          >

  ...
  return (
    <div>
      <div className="flex justify-between gap-x-3 text-[#6D6D6D]">
        <div className=" flex flex-col gap-y-6 border border-[#7E7E7E] p-6 font-poppins bg-[#FFFFFF] w-[710px]">
        ...
        <div className=" flex flex-col gap-y-6 border border-[#7E7E7E] p-6 font-poppins bg-[#FFFFFF] w-[370px]">
      ...
      <div className="flex items-end justify-end">
        <div className="flex items-center gap-x-3 mt-4 ">
          <button className="px-4 py-1 w-[130px] text-white bg-[#7E7E7E] border border-[#7E7E7E] cursor-pointer">
            View Logs
          </button>

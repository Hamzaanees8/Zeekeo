...
const isCompany = (item) =>
  !isEmail(item) && !isURL(item) && !isDomain(item);
    ...
    <div className="p-6 bg-[#EFEFEF] min-h-screen">
      ...
      <div className="flex gap-2 mb-4">
        {tabs.map(tab => (
          <button
            ...
            className={`px-4 py-1 border text-[16px] cursor-pointer ${activeTab === tab
      ...
      <div className="flex items-start gap-4 justify-between mb-4">
        <div className="flex gap-2">
          <div className="flex flex-col">
            <input
              ...
              className="border border-[#7E7E7E] px-3 py-1 text-sm w-[435px] bg-white"
            />
          ...
          <button onClick={handleAdd} className="border border-[#7E7E7E] text-[#7E7E7E] px-4 py-1 bg-white text-sm h-fit flex gap-2 items-center cursor-pointer">
        ...
        <button
          ...
          className="border border-[#7E7E7E] text-[#7E7E7E] px-4 py-1 bg-white text-sm flex gap-2 items-center cursor-pointer"
        >
      ...
      <div className="relative w-[500px] h-[316px] pr-2 py-3 bg-white border border-[#7E7E7E]">
      ...
      {showPopup && (
        ...
        >
          <div className="bg-white w-[550px] p-6 shadow-lg relative">
            {popupMode == 'delete' &&
              ...
              <div className="flex flex-col items-start mb-[10px]">
                ...
                <div className="flex gap-[20px] max-w-full mt-[10px]">
                  <textarea
                    ...
                    className="border border-[#7E7E7E] px-3 py-1 text-sm w-[435px] h-[270px] bg-white resize-none"
                    rows={4}
                  />
                  <button onClick={handleAddBulk} className="w-[200px] h-[33px] border border-[#7E7E7E] text-[#7E7E7E] px-4 py-1 bg-white text-sm flex gap-2 items-center cursor-pointer">
                    <PlusIcon className="fill-[#7E7E7E] w-3 h-3" /> Add to Blacklist
                  </button>
                </div>
              </div>
            }
            <div className={`relative w-[500px] ${popupMode == 'add' ? 'h-[130px]' : "h-[330px]"} h-[130px] pr-2 py-3 bg-white border border-[#7E7E7E]`}>
              <div className="scrollable-div px-3 pr-0 w-full h-full overflow-y-scroll">
                <div className="pr-3">
                  {popupMode === "add" ? (
                    ...
                    deleteSelection.map((item, index) => (
                      <div key={index} className="flex justify-between items-center py-2 text-sm">
                        <span className="text-[#6D6D6D]">{item}</span>
                        <button
                          onClick={() => handleRemoveFromDeleteSelection(index)}
                          className="text-[#D62828] hover:scale-101 transition border border-[#D62828] p-[2px] cursor-pointer"
                        >
                          <DeleteIcon className="w-3 h-3" />
                        </button>
            ...
            <div className="flex justify-between items-center mt-[10px]">
              <button
                ...
                className="bg-[#7E7E7E] text-white px-6 py-1 cursor-pointer  ">
                Cancel
              </button>
              <button
                onClick={handleDone}

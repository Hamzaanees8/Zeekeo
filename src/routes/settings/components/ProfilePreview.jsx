...
const FilterPreviewPopup = () => {
  ...
  return (
    <div className="border border-[#7E7E7E] bg-white w-full shadow-lg p-6">
      ...
      <table className="w-full text-sm ">
        ...
        <tbody>
          {mockProfiles.map((profile, idx) => (
            <tr
              key={idx}
              className="border-b border-[#7E7E7E] text-[#6D6D6D] hover:bg-[#f9f9f9]"
            >
              <td className="py-2 px-2">{idx + 1}</td>
              <td className="py-2 px-2">
                <span className="w-[35px] h-[35px] rounded-full bg-[#D9D9D9] inline-block" />
              </td>
...
export default FilterPreviewPopup;

...
export default function HubSpotExistingContacts() {
  ...
  // Extract profile URLs from the selected contacts
  ...
  // if the "Create Campaign" button should be enabled
  ...
  const fetchContacts = async (after = null, append = false) => {
    try {
      ...
      const data = await getHubSpotContacts(queryParams);
  ...
  const handleCreateCampaign = async (campaignName) => {
    ...
    const campaignData = {
      campaign: {
        ...
        workflow: {}, // Placeholder for workflow
      },
                  ...
                  <tr>
                    ...
                    <th className="p-2 w-[40px] text-center">
                      <input
                        ...
                        // Disable header checkbox if no selectable contacts are present
                        ...
                        >
                          ...
                          <td className="text-center">
                            <input
                              ...
                              // Contacts without a profile URL are non-selectable
                              disabled={!hasProfile}
                              title={
                                !hasProfile
